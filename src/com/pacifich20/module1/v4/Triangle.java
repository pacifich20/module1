...
public class Triangle extends TwoDShape implements Rotate {
    ...
    /**
     * creates triangle using given width, height and color
    ...
    public String toString() {
        return "Triangle side length 1 = " + side1 + ", side length 2 = " + side2 + ", side length 3 = " + side3 + ", width = " + super.getWidth() + ", height = " + super.getHeight() + ", angle = " + angle + ", color = " + super.getColor();
    }
